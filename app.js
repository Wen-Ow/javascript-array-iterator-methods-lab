...
// I could use the map method to iterate over the array and return a new array with the desired format.
// I used the return statement to return a new object with the desired properties.
...
// I could sort by value of the year property because it is a number. If it was a string, I would have to convert it to a number before sorting.
// Sort by value usign "items.sort((a, b) => a.value - b.value);" or "items.sort((a, b) => Number(a.value) - Number(b.value));"
...
// I could use the find method to iterate over the array and return the first element that matches the condition.
...
// I could use the map method to iterate over the array and return a new array with the desired format.
// I used destructuring to assign the values of the split array to the variables last and first.
...
/*
Exercise 6: Array.prototype.some() and the date() constructor
...
// I could use the .some() method to iterate over the array and return true if at least one element matches the condition.
// new Date().getFullYear() returns the current year (for example, 2024). To dynamically get today's date, I used the new Date() constructor.
// person.year is the year of birth of the person.
// Subtracting the year of birth from the current year gives the age of the person. If the age is greater than or equal to 18, the person is an adult. If at least one person is an adult, the method returns true.
...
/*
Exercise 7: Array.prototype.every() and the date() constructor
...
// I could use the .every() method to iterate over the array and return true if all elements match the condition.
// new Date().getFullYear() returns the current year (for example, 2024). To dynamically get today's date, I used the new Date() constructor.
// person.year is the year of birth of the person.
// Subtracting the year of birth from the current year gives the age of the person. If the age is greater than or equal to 19, the person is 19 or older. If all people are 19 or older, the method returns true.
...
// I could use the find method to iterate over the array and return the first element that matches the condition.
// I used the return statement to return the first element that matches the condition.
// I used the strict equality operator (===) to compare the id property of the comment object with the number 823423.
...
// I could use the findIndex method to iterate over the array and return the index of the first element that matches the condition.
// I used the strict equality operator (===) to compare the id property of the comment object with the number 123523.
